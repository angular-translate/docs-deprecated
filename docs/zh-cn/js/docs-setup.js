NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "moduleName": "安装",
      "shortDescription": "安装",
      "keywords": "angular-translate angular-translate-interpolation-default angular-translates bower build clone conf dist estrunner git github grunt gruntfile guide https install io js karma love midway min npm overview start testrunner unicorn unit"
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "keywords": "$emit $on $rootscope $scope $translate $translatechangesuccess $translateprovider add angular angular-translate anotherone app awesome call config controller ctrl en error expose features function guide headline love module myapp namespace namespaced_paragraph ng-app ng-controller overview paragraph pascalprecht preferredlanguage returns service srsly table translate translation translations unicorn var versioninfo"
    },
    {
      "section": "guide",
      ...
      "keywords": "$scope $translate $translateprovider add angular angular-translate angularjs app awesome config controller ctrl en function generalusage guide headline love module myapp ng-controller org overview paragraph pascalprecht preferredlanguage srsly table translate translation translation_id translations unicorn var"
    },
    {
      "section": "guide",
      ...
      "keywords": "$compile $scope $translateprovider add angular angular-translate app attribute awesome beginners config controller cool ctrl en false function guide ha headline hey interpolated love module myapp ng-controller overview paragraph pascalprecht passed passed_as_attribute passed_as_interpolation passed_as_text preferredlanguage srsly table text translate translate-compile translation translation_id translations unicorn usepostcompiling var"
    },
    {
      "section": "guide",
      ...
      "keywords": "$scope $translate $translateprovider add angular angular-translate app attribute awesome beginners config controller cool ctrl en function greeting guide ha headline hey html interpolated javascript lastlogin logged love module myapp ng-controller overview paragraph pascal pascalprecht pascalprect passed passed_as_attribute passed_as_interpolation passed_as_text preferredlanguage somescopeobject srsly table text translate translate-value- translate-value-name translate-values translation translation_id translationdata translations unicorn username var variable_replacement"
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "type": "overview",
      "moduleName": "自定义插值器",
      "shortDescription": "自定义插值器",
      "keywords": "$interpolate $locale $scope $translate $translateprovider addinterpolation angular angular-translate app benutze bin button_lang_de button_lang_en changelanguage config context controller ctrl custom custominterpolation de default deutsch eine en englisch english es factory fand fanden female function german getinterpolationidentifier guide gut headline ich interpolate interpolateparams interpolation locale love male messageformat module myapp ng-click ng-controller overview pascalprecht plural preferredlanguage return sanitizestrategy select setlocale text translate translate-values translationid translations unicorn useinterpolation useloader usestorage val var"
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "moduleName": "工具",
      "shortDescription": "工具",
      "keywords": "angular-translate app boolean cleanprevstrings create default dev devonefile dist false file files generate gettext github grunt grunt-angular-translate grunt-po2json-angular-translate gruntfile guide initconfig install js json loadnpmtasks msgid names npm options optionsenablealtplaceholders optionsuppercaseid overview pluralization po po2json_angular_translate pretty single strings test tmp true type uppercaseid your_target"
    },
    {
      "section": "guide",
